  ...
  <div id="admin-content">
      <div class="container">
          <div class="row">
              ...
              <div class="col-md-2">
                  <a class="add-new" href="add-post.php" style="background-color:green">add post</a>
              </div>
              <div class="col-md-12">
              <?php
                  include "config.php";
                  ...
                  <table class="content-table">
                      ...
                      <?php
                          ...
                          <tr>
                              ...
                              <td class='delete'><a href='delete-post.php?id=<?php echo $row['post_id']; ?>&cat-id=<?php echo $row['category']; ?>'><i class='fa fa-trash-o'></i></a></td>
                          </tr>
                          <?php } ?>
                      </tbody>
                  </table>
